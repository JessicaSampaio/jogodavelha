...
_____|_____|_____
  ...
  7  |  8  |  9  
    ...
    print('Você quer ser o X ou a O ?', end=' ')
# ! diferente
    while j != 'O' and j != 'X':
    ...
    while primeiro != 'EU' and primeiro != 'VC':
        instr = 'Digite EU e pressione enter para você começar, ou digite VC e precione enter para o computador começar: '
        primeiro = str(input(instr)).strip().upper()
        if primeiro != 'EU' and primeiro != 'VC':
            print('\nEscolha inválida!\n')
    ...
    def rotina_j1():
        ...
        while jogada not in range(1, (9 + 1)):
            ...
            if jogada not in range(1, (9 + 1)):
                print('\nNúmero inválido!\n')
#quando já tiver sido preenchido
    ...
    def checar_vencedor():
        global j, adv, turnos, vencedor, jogador, vc
        global p1, p2, p3, p4, p5, p6, p7, p8, p9
    ...
    print('-------- PLACAR --------')
    print('Você: {} | Computador: {}'.format(jogador, computador))
    print('------------------------')
